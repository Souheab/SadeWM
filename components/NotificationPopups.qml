...
// Floating toast notifications that appear top-right, stacked vertically.
// Each auto-dismisses after its expireTimeout; hovering pauses the timer.
// Uses NotificationService.popupQueue as the data source.
Item {
    id: root
    anchors.fill: parent
