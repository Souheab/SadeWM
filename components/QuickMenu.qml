...
// Quick-launch menu — configs, apps, utilities, and power submenu.
// Reparented to the popup layer, same pattern as before.
Rectangle {
    id: configMenu
                    ...
                    Rectangle {
                        ...
                        MouseArea {
                            ...
                            onClicked: {
                                configMenu.confirmOpen = false
                                configMenu.closeRequested()
                                execProcess.command = ["python3", Qt.resolvedUrl("../scripts/qsctrl").toString().replace("file://", ""), "power", configMenu.pendingAction]
