...
Window {
    ...
    readonly property int windowCount: WindowPickerService.windowsModel.count
    ...
    function open() {
        ...
        selectedIndex = 0
        searchBox.clear()
        WindowPickerService.windowsModel.setFilter("")
    ...
    function _applyFilter(query) {
        WindowPickerService.windowsModel.setFilter(query)
    ...
    function selectWindow() {
        if (selectedIndex >= 0 && selectedIndex < windowCount) {
            var w = WindowPickerService.windowsModel.get(selectedIndex)
    ...
    Rectangle {
        ...
        Item {
            ...
            GridView {
                ...
                model: WindowPickerService.windowsModel
