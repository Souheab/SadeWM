...
Window {
    ...
    function reportScreenGeometry() {
        FullscreenService.setScreenGeometry(root.x, root.y, root.width, root.height)
    }
    onXChanged: reportScreenGeometry()
    onYChanged: reportScreenGeometry()
    onWidthChanged: reportScreenGeometry()
    onHeightChanged: reportScreenGeometry()
