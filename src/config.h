...
static char col_border_norm[8] = "#444444"; /* unfocused window border */
static char col_border_sel[8]  = "#0099ff"; /* focused window border */
...
static const Key keys[] = {
  ...
  { MODKEY|ControlMask,           XK_h,      setmfact,       {.f = -0.05} },
	...
	{ MODKEY,                       XK_space,  layoutnext,     {0} },
	{ MODKEY|ShiftMask,             XK_space,  layoutprev,     {0} },
